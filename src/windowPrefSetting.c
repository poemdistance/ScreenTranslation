...
static void on_save_button_click_cb ( 
    ...
    WindowPrefSettingWindowData *wpswd = 
...
static void updateLayout  (
    ...
    WindowPrefSettingWindowData *wpswd = swd->windowPrefSettingWindowData;
...
void windowPrefSetting ( SettingWindowData *swd ) {
    ...
    static WindowPrefSettingWindowData wpswd;
    ...
    /* gtk_widget_set_size_request ( swd->contentScrollWindow, 400, 400 ); */
